...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-5JA1DBH;Database=HastaneSabah;Trusted_Connection=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Bolumler>(entity =>
            {
                ...
                entity.HasIndex(e => e.BolumAd, "UQ__Bolumler__7BD2881BFBE24BC9")
                    .IsUnique();
            ...
            modelBuilder.Entity<Doktorlar>(entity =>
            {
                ...
                entity.HasIndex(e => e.SicilNo, "UQ__Doktorla__B736D3C2C52525B2")
                    .IsUnique();
                ...
                entity.HasOne(d => d.Bolum)
                    ...
                    .HasConstraintName("FK__Doktorlar__Bolum__3E52440B");
            });
            ...
            modelBuilder.Entity<Hastalar>(entity =>
            {
                ...
                entity.HasIndex(e => e.TcNo, "UQ__Hastalar__8EF935A6D93BFB98")
                    .IsUnique();
