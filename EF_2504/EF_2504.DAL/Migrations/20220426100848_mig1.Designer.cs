            ...
            modelBuilder.Entity("EF_2504.DAL.Entities.Author", b =>
                {
                    ...
                    b.Property<DateTime>("AuthorCreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 26, 13, 8, 47, 774, DateTimeKind.Local).AddTicks(6733));
            ...
            modelBuilder.Entity("EF_2504.DAL.Entities.Book", b =>
                {
                    ...
                    b.Property<DateTime>("BookCreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 26, 13, 8, 47, 790, DateTimeKind.Local).AddTicks(7343));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookImageUrl = "https://cdn.bkmkitap.com/yonetim-bilisim-sistemleri-ciltli-9200779-11-O.jpg",
                            BookName = "Yönetim Bilişm Sistemleri",
                            BookPrice = 0m,
                            CategoryId = 1
                        },
                        new
                        {
                            BookId = 2,
                            BookCreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            BookImageUrl = "https://cdn.bkmkitap.com/adan-zye-php-3773727-41-O.jpg",
                            BookName = "A'dan Z'ye Reset",
                            BookPrice = 0m,
                            CategoryId = 2
                        },
                        new
                        {
                            BookId = 3,
                            BookCreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            BookImageUrl = "https://www.karadenizdesonnokta.com.tr/images/haberler/2021/10/dunyaca-unlu-site-trabzonspor-u-sampiyon-ilan-etti_f54a1.jpg",
                            BookName = "Şampiyon Trabzonspor",
                            BookPrice = 0m,
                            CategoryId = 3
                        });
                });
